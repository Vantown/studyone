...
jQuery.fn.roundabout_animateToBearing = function (bearing) {
    ...
    this.each(function (i) {
        ...
        if (data === null) {
            data = {timerStart: currentTime, start: jQuery.roundabout_getBearing(ref), totalTime: thisDuration}
        }
...
jQuery.roundabout_updateChildPosition = function (child, container, data, childPos) {
    ...
    var itemData = {startWidth: startPos[0], startHeight: startPos[1], startFontSize: startPos[2], degrees: parseFloat(ref.attr('degrees'), 4)};
