...
if(!window.localStorage)document.write('<script src="/bower_components/localstorage.js/localstorage.js"></script>');
if(!window.JSON)document.write('<script src="/bower_components/json.js/json.js"></script>');
...
define("promise#!resolve,reject,all,race,then,catch",["/bower_components/promise.js/promise.js"],function(Promise){
  return Promise;
});
...
var Server=require("server.js?1444596289#on,trigger,bind,sign,put,query,noop,pull,cached,cascade,invoke,conch.hello,conch.bye,conch.getCounter");
var County=require("county.js?1444596289#insert,get,remove,last,getParameters,on,one,has");
var highlight=require("highlight.js?1462127842#!decodeHTML");
var md5=require("md5.js?1444596289#!md5");
var gesture=require("gesture.js?1444596289#!on");
var dialog=require("dialog.js?1444596289#!popup,cancel,lock,unlock,on");
var action={
  index:require("action.index.js?1444596289#!"),
  articlelist:require("action.article.list.js?1444596289#!"),
  articledetail:require("action.article.detail.js?1444596289#!"),
  subjectpublish:require("action.subject.publish.js?1444596289#!"),
  subjectlistst:require("action.subject.list.st.js?1444596289#!"),
  subjectlistpg:require("action.subject.list.pg.js?1444596289#!"),
  subjectdetail:require("action.subject.detail.js?1444596289#!"),
  subjectdetailim:require("action.subject.detail.im.js?1444596289#!"),
  subjectdetailpg:require("action.subject.detail.pg.js?1444596289#!"),
  selection:require("action.selection.js?1444596289#!")
},common={
  makeTornado:require("common.maketornado.js?1444596289#!"),
  makeXEditor:require("common.makexeditor.js?1444596289#!"),
  popupSettings:require("common.popupsettings.js?1444596289#!"),
  popupPreview:require("common.popuppreview.js?1444596289#!")
},baidu={
  share:require("baidu.share.js?1444596289#!")
};
...
//创建本地数据缓存对象
var database=new SimpleIDB("web-tinker",12,{
  articles:[{keyPath:"id"},{
...
var common=new MixtureModel(common,{
  makeAT:function(n,content){
    ...
    if(isIE)
      t=content.prop("createTextRange")(),
      t.moveStart("character",l),
      t.select();
    else content.prop({selectionStart:l,selectionEnd:l});
      ...
      highlight(source,type=="demo"?"html":type,function(e){
        ...
        if(type=="demo")$("<a/>").addClass("run").text("运行").click(function(){
          highlight.decodeHTML(source,function(code){
            // Chrome@Mac 不支持 Blob 设置的 charset，固使用此蠢办法
            code=code.replace(/(^\s*<!DOCTYPE[^>]*>|^)/i,'$1<meta charset="utf-8" />');
            // 根据不同浏览器选择可支持的打开方式
    ...
    var r=/(@.+?(?=&nbsp;|<br\/>))|(<img[\s\S]+?>)|(<audio[\s\S]+?>)|(<code[\s\S]+?<\/code>)|(\s+)|(<[\s\S]+?>)/g;
    e=(e||"").replace(r,function($0,at,img,ado,code,space,tag){
...
(function(){
  ...
  var f = function(s) {
    return s.replace('微软雅黑', yahei).replace(/\bConsolas\b/ig, consolas);
  };
...
(function(f,ready){
  ...
  document.getElementById("blackbox")&&$.ajax({
    url:"//hm.baidu.com/h.js?a855f89c898f1b86f43caea384f74651",
